 ...
 */
final class Version20211110150751 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE expedientes (id INT AUTO_INCREMENT NOT NULL, fondo_id INT NOT NULL, legajo_id INT NOT NULL, estante_id INT NOT NULL, anaquel_id INT NOT NULL, numero VARCHAR(3) NOT NULL, identificador VARCHAR(255) NOT NULL, descripcion LONGTEXT NOT NULL, INDEX IDX_D59CA413AA510E89 (fondo_id), INDEX IDX_D59CA413602BF2CE (legajo_id), INDEX IDX_D59CA413B3E5B35F (estante_id), INDEX IDX_D59CA413FD9D1662 (anaquel_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
